# Memory App Template - 335 Mobile-Applikation realisieren

Template for mini project "Memory App" of ICT Module 335.

*Optional*: A predefined set of images are located at [/images](./images).
